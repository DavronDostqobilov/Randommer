...
ans=Text()
print(ans.generate_LoremIpsum('7b3b6035a5c94aee8908aaa68c9a6fe4','normal', 'paragraphs',4))
print(ans.generate_password('7b3b6035a5c94aee8908aaa68c9a6fe4',4,True,True,False))